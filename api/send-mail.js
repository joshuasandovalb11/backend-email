...
const senderName = 'Registros de Venta';
// ------------------------------
...
export default async function handler(req, res) {
  ...
  try {
    ...
    //    Utiliza variables de entorno para no escribir la contraseña en el código.
    ...
    // 4. Construimos el contenido del correo (puedes personalizar este HTML como quieras).
    const mapLink = `https://www.google.com/maps?q=${latitude},${longitude}`;
    const currentTime = new Date().toLocaleString('es-MX', { dateStyle: 'long', timeStyle: 'short' });
    ...
    const emailHtml = `
        ...
        <body style="margin: 0; padding: 0; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif; background-color: #f7f8fc; line-height: 1.6; color: #2d3748;">
            <div style="max-width: 700px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 8px 25px rgba(0,0,0,0.08); border-radius: 16px; overflow: hidden;">
